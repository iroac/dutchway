...
<Link to="/videos" className="flex flex-col mx-auto shadow-md h-52 w-52 justify-center items-center cursor-pointer hover:shadow-blue-flag" ><RxVideo className="text-8xl text-blue-flag" /> <h1 className="text-xl text-blue-flag" >VIDEOS</h1> </Link>
