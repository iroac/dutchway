...
<Link to="/textmaterial" className=" flex flex-col mx-auto shadow-md h-52 w-52 justify-center items-center cursor-pointer hover:shadow-red-flag"> <BiBookBookmark className="text-8xl text-red-flag" /> <h1 className="text-xl text-red-flag" >TEXT</h1> </Link>
