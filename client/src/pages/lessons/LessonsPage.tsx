...
function LessonsPage() {
  ...
  return <div className="flex flex-col justify-start w-screen h-screen bg-slate-50">
    ...
    <Link to="/wordtowordlesson/eng" className=" flex flex-col shadow-md h-20 w-8/12 justify-center items-center bg-blue-flag cursor-pointer rounded-full hover:shadow-black"> <h1 className="text-lg text-white" >WORDS - ENG/DUTCH</h1> </Link>
    </div>


    <div className="flex flex-row justify-center items-center w-screen px-2 mt-10 h-1/4 gap-5">
    <Link to="/phraseslesson/eng" className=" flex flex-col shadow-md h-20 w-3/12 rounded-full bg-red-flag justify-center items-center cursor-pointer hover:shadow-black"> <h1 className="   text-xs sm:text-lg text-center text-white" >PHRASES</h1> <h1 className="   text-xs sm:text-lg text-center text-white" >ENG/DUTCH</h1> </Link>
    <Link to="/phraseslesson/dutch" className=" flex flex-col shadow-md h-20 w-3/12 rounded-full bg-red-flag justify-center items-center cursor-pointer hover:shadow-black"> <h1 className="  text-xs sm:text-lg text-center text-white" >PHRASES</h1> <h1 className="  text-xs sm:text-lg text-center text-white" >DUTCH/ENG</h1>  </Link>
    <Link to="/wordtowordlesson/dutch" className=" flex flex-col shadow-md h-20 w-6/12 rounded-full bg-blue-flag justify-center items-center cursor-pointer hover:shadow-black"> <h1 className="text-lg text-center text-white" >WORDS - DUTCH/ENG</h1> </Link>
    </div>
    </div>
