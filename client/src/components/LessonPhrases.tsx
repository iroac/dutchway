...
axios.put(`http://localhost:3000/users/${user?.id}`, pointUser)
  ...
  const handleCheckButton = () => {
    let hasEnglish = questions[currentQuestionIndex].phrases.some((phrase) => phrase.english === text);
    let hasDutch = questions[currentQuestionIndex].phrases.some((phrase) => phrase.dutch === text);
